...
const { FB_API_VER } = process.env;

const FB_MESSENGER_ENDPOINT = `https://graph.facebook.com/${FB_API_VER}/me/messages`;
const FB_PROFILE_ENDPOINT = `https://graph.facebook.com/${FB_API_VER}/`;
const FB_SETTINGS_ENDPOINT = `https://graph.facebook.com/${FB_API_VER}/me/thread_settings`;
...
FBBotFramework.prototype.send = function (recipient, messageData, notificationType, cb) {
    ...
    request(typing_req, function (err, res, body) {
        if (cb) {
